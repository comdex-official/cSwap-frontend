...
import {
  BASE_COIN_POOL_PRICE_SET, FARMED_TOKENS_DOLLAR_VALUE, FIRST_RESERVE_COIN_DENOM_SET, NORMAL_REWARD_DOLLAR_VALUE_PER_DAY_SET, POOLS_LIQUIDITY_LIST_SET, POOLS_SET, POOL_APR_SET, POOL_BALANCES_SET, POOL_BALANCE_FETCH_IN_PROGRESS, POOL_BALANCE_SET, POOL_DEPOSITS_SET, POOL_INCENTIVES_SET, POOL_PRICE_SET, POOL_SET, POOL_TOKEN_SUPPLY_SET, SECOND_RESERVE_COIN_DENOM_SET, SPOT_PRICE_SET, SWAP_APR_SET, SWAP_REWARD_DOLLAR_VALUE_PER_DAY_SET, USER_LIQUIDITY_IN_DOLLAR_SET,
...
const userLiquidityInPools = (state = {}, action) => {
  if (action.type === USER_LIQUIDITY_IN_POOLS_SET && action?.value) {
    return {
      ...state,
