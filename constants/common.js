...
export const FIAT_URL = `https://app.kado.money?apiKey=${process.env.NEXT_PUBLIC_FIAT_API_KEY}&onPayCurrency=USD&onRevCurrency=CMDX&offPayCurrency=CMDX&offRevCurrency=USD&onPayAmount=200&offPayAmount=50&network=COMDEX&cryptoList=USDT,USDC,CMDX&fiatList=USD,CAD,EUR&product=BUY&productList=BUY,SWAP`;
