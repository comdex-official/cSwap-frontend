      ...
      <div className={`${style.govern_main_container} ${style.max_width}`}>
        <div className={style.govern_container}>
          ...
          <div className={style.govern_upper_main_container}>
            <div className={style.govern_upper_container}>
              <List
                ...
                className={`${style.govern_upper_container_list} ${"govern_ant_list_class"}`}
                dataSource={data}
                renderItem={item => (
                  <List.Item >
                    <div>
          ...
          <div className={style.govern_bottom_main_container}>
            <div className={style.govern_bottom_container} onClick={() => router.push(`/govern/${1}`)}>
              <div className={style.govern_bottom_filters_container}>
                <div className={style.governcard_head}>
                  <Button type='primary' className={`${"btn-filled"} ${style.btn_filled}`}>New Proposal</Button>
                  <a href="https://forum.comdex.one/" target="_blank" rel="noreferrer"><Button type="primary" className="btn-filled">Forum</Button></a>
                  <Select defaultValue="Filter" className="select-primary ml-2" style={{ width: 120 }} >
                ...
                <div className={style.governlist_row}>
                  <div className={style.left_section}>
                    ...
                    <div className={style.proposal_status_container}>
                      ...
                      <div className={style.proposal_status_container}>
                        <div className={`${style.proposal_status} ${style.passed_color}`}>
                          Passed
                        </div>
                      </div>
                    </div>
                    <h3>Lorem ipsum dolor sit amet.</h3>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Iure  dolore quod et similique? Dolor beatae sint facere debitis nobis odio, nam maiores optio distinctio natus iusto fugit quisquam. </p>
                  </div>
                      ...
                      <div className={style.user_vote_box_container}>
                        <div className={style.user_vote_box}>
                          ...
                          <div className={style.single_vote_container}>
                            <div className={`${style.boder} ${style.yes_border}`}></div>
                          ...
                          <div className={style.single_vote_container}>
                            <div className={`${style.boder} ${style.no_border}`}></div>
                            <div className={style.text_container}>
                          ...
                          <div className={style.single_vote_container}>
                            <div className={`${style.boder} ${style.veto_border}`}></div>
                            <div className={style.text_container}>
                          ...
                          <div className={style.single_vote_container}>
                            <div className={`${style.boder} ${style.abstain_border}`}></div>
                            <div className={style.text_container}>
                    ...
                    <div className="mt-3">
                      <div>
                        <Progress
                          ...
                          size={10}
                          sections={[
                            { value: 20, color: '#03d707c4', tooltip: 'Yes' + " " + 20 + "%" },
                            { value: 15, color: '#FF6767', tooltip: 'No' + " " + 15 + "%" },
                            { value: 25, color: '#c0c0c0', tooltip: 'No With Veto' + " " + 25 + "%" },
                            { value: 40, color: '#b699ca', tooltip: 'Abstain' + " " + 40 + "%" },
                          ]}
                        />
