          ...
          <div className="disclaimer-box-container">
            <div>
              <p>
                ...
                https://cswap.one/ (being the Website referred to in the Terms
                (as defined below); (b) the cSwap Smart Contracts; and (c) the
                Comdex Chain on which the cSwap Smart Contracts are deployed,
            ...
            <div className="border-box">
              <p>
                cSwap (which includes the Website, the cSwap Smart Contracts and
                Comdex Chain are not intended for (a) access and/or use by
              ...
              <p>
                ...
                to access and/or use cSwap from an Excluded Jurisdiction, you
            ...
            <div>
              <p>
                The terms “cSwap Smart Contracts” and “Comdex Chain”
                (collectively referred to as “cSwap”) as well as “Excluded
                Persons” and “Excluded Jurisdictions” are as defined in the
                Terms.
              </p>
            </div>
            <div>
              <p>
                Upgrades and modifications to cSwap are managed in a
                community-driven way by governance vote of holders of the CMDX
                Token native to the Comdex blockchain. There may be changes to
                the Terms since you had last accessed and/or used cSwap.
              </p>
            </div>
            <div>
              <p>
                By proceeding to access and/or use cSwap you are agreeing to the
